      ...
      <h1 class="text-xl font-semibold ml-20 mt-20 mb-3 md:ml-120"><?php echo "1: What does php stands for?" ?></h1>
         ...
         <input type="radio" name="answer" value="Public Hosting Program" class="ml-30 md:ml-130"><label for="" class="ml-2 p-1">Public Hosting Program</label><br>  
            ...
            <button class="bg-gray-500 p-3 ml-20 w-40  rounded mt-5 hover:bg-blue-400 hover:text-white cursor-pointer text-xl md:ml-130"><a href="log.php">previous</a></button> 
             <button class="bg-gray-500 p-3 ml-10 w-40 md:mr-80 rounded mt-5 hover:bg-blue-400 hover:text-white cursor-pointer text-xl md:ml-130"><a href="question.2.php">Next</a></button> 
